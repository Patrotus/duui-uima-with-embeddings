...
//        System.out.println(stream.toString(StandardCharsets.UTF_8));
    ...
    public void createCas(String language, List<String> texts, List<String> imagePaths, List<String> videoBase64s, List<String> audioPath) {
        cas.setDocumentLanguage(language);

        // FIXME: Does not seem correct for processing texts
        ...
        for (String imagePath : imagePaths) {
            ...
            img.setSrc(convertImageToBase64(imagePath));
            img.addToIndexes();
        }
        ...
        for (String videoBase64 : videoBase64s) {
            Video video = new Video(cas);
            video.setMimetype("video/mp4");
            video.setSrc(videoBase64);
            video.addToIndexes();
        }
    }
